      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-4">
            <div className="mb-6">
              <a href="#" className="flex items-center w-max">
                <img src="/logo-whitetext.png" alt="Choco Code Logo" className="h-16 md:h-20 -ml-4" />
              </a>
            </div>
          ...
          <div className="lg:col-span-4">
            ...
            <a href="https://www.fiverr.com/choco_code" className="text-[15px] text-cc-yellow-light hover:text-cc-yellow flex items-center transition-colors duration-300 font-medium">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4">
              {['Home', 'Portfolio', 'Services', 'Teams'].map((item) => (
                <li key={item}>
                  <a href={`#${item.toLowerCase()}`} className="text-[15px] text-white/50 hover:text-cc-yellow-light flex items-center transition-colors duration-300 group">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4">
              {['Fiverr Profile', 'Contact Us', 'Client Reviews', 'Our Goals'].map((item) => (
                <li key={item}>
                  <a href="https://www.fiverr.com/choco_code" className="text-[15px] text-white/50 hover:text-cc-yellow-light flex items-center transition-colors duration-300 group">
                    <span className="font-mono text-white/20 mr-2 text-xs group-hover:text-cc-yellow transition-colors">//</span>
                    {item}
                  </a>
                </li>
