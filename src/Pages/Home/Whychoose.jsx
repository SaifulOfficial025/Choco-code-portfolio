...
const whyChooseCards = [
  {
    ...
    desc: 'Your go-to AI partner on Fiverr, delivering custom solutions in chatbots, models, automation, and data-driven innovation worldwide. We bring 5+ years of deep technical expertise to every project.',
    gradientFrom: '#4ade80',
    gradientTo: '#15803d',
    icon: Award
  },
  {
    ...
    desc: 'Proven track record of consistently exceeding client expectations with top-quality AI, app, and web solutions tailored to your goals.',
    gradientFrom: '#fde047',
    gradientTo: '#eab308',
    icon: Target
  },
  {
    ...
    desc: 'Committed to delivering high-quality AI, app, and web projects on schedule—every time, without compromising on performance or precision.',
    gradientFrom: '#bbf7d0',
    gradientTo: '#22c55e',
    icon: Clock
  },
