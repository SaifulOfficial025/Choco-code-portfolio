...
function Hero() {
  ...
  return (
    <section className="w-full relative pt-32 pb-16 overflow-hidden">
      <div className="absolute top-20 left-1/2 -translate-x-1/2 w-[900px] h-[500px] bg-gradient-to-br from-cc-green-50/50 via-cc-yellow-50/30 to-transparent rounded-full blur-3xl pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-12">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-[76px] font-extrabold text-cc-black leading-[1.08] tracking-tight font-serif mb-8">
            Professional <br/>
          ...
          <p className="text-cc-gray text-lg md:text-xl max-w-2xl mx-auto font-medium leading-relaxed mb-10">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="hidden lg:block absolute -left-4 top-8 z-20 animate-float" style={{animationDelay: '0s'}}>
          ...
          <div className="hidden lg:block absolute -right-4 top-4 z-20 animate-float" style={{animationDelay: '1s'}}>
            <div className="bg-white rounded-2xl px-5 py-4 shadow-xl shadow-cc-green/5 border border-cc-green/10 text-center">
          ...
          <div className="hidden lg:block absolute left-8 bottom-8 z-20 animate-float" style={{animationDelay: '2s'}}>
            <div className="bg-white rounded-2xl px-5 py-4 shadow-xl shadow-cc-green/5 border border-cc-green/10 text-center">
